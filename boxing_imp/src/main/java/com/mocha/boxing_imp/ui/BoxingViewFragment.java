...
import com.mocha.boxing_imp.adapter.BoxingAlbumAdapter;
import com.mocha.boxing_imp.adapter.BoxingMediaAdapter;
import com.mocha.boxing_imp.view.MediaItemLayout;
...
public class BoxingViewFragment extends AbsBoxingViewFragment implements View.OnClickListener {
    ...
    private void initRecycleView() {
        ...
        mRecycleView.addItemDecoration(new SpacesItemDecoration(getResources().getDimensionPixelOffset(R.dimen.grid_item_spacing), GRID_COUNT));
